...
package workspace_talend_delitos_caba.job_recarga_delitos_caba_0_1;
...
/**
 * Job: Job_Recarga_Delitos_CABA Purpose: <br>
 * Description: Recarga los 3 procesos de tranformación: Delitos_2019,
 * Delitos_2020 y Delitos historicos <br>
 * 
 * @author
 * @version 7.3.1.20200219_1130
 * @status
 */
public class Job_Recarga_Delitos_CABA implements TalendJob {
	...
	private final String jobName = "Job_Recarga_Delitos_CABA";
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_yLQ9YB44EeyABrm1GcymaQ", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_yLQ9YB44EeyABrm1GcymaQ", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_Recarga_Delitos_CABA.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_Recarga_Delitos_CABA.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void talendMeter_DB_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA = new byte[0];
		static byte[] commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				workspace_talend_delitos_caba.delitos_2019_0_1.Delitos_2019 childJob_tRunJob_1 = new workspace_talend_delitos_caba.delitos_2019_0_1.Delitos_2019();
				// pass DataSources
				...
				for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
					...
					workspace_talend_delitos_caba.delitos_2020_0_1.Delitos_2020 childJob_tRunJob_2 = new workspace_talend_delitos_caba.delitos_2020_0_1.Delitos_2020();
					// pass DataSources
					...
					workspace_talend_delitos_caba.delitos_historicos_0_1.Delitos_historicos childJob_tRunJob_3 = new workspace_talend_delitos_caba.delitos_historicos_0_1.Delitos_historicos();
					// pass DataSources
				...
				talendStats_STATS.addMessage("end", "tRunJob_1",
						end_Hash.get("tRunJob_1") - start_Hash.get("tRunJob_1"));
				talendStats_STATSProcess(globalMap);
				...
				talendStats_STATS.addMessage("end", "tRunJob_2",
						end_Hash.get("tRunJob_2") - start_Hash.get("tRunJob_2"));
				talendStats_STATSProcess(globalMap);
				...
				talendStats_STATS.addMessage("end", "tRunJob_3",
						end_Hash.get("tRunJob_3") - start_Hash.get("tRunJob_3"));
				talendStats_STATSProcess(globalMap);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (properties_connectionStatsLogs == null || properties_connectionStatsLogs.trim().length() == 0) {
					properties_connectionStatsLogs += "rewriteBatchedStatements=true&allowLoadLocalInfile=true";
						...
						&& !properties_connectionStatsLogs.contains("rewriteBatchedStatements")) {
					properties_connectionStatsLogs += "&rewriteBatchedStatements=true";
				}
				if (properties_connectionStatsLogs != null
						&& !properties_connectionStatsLogs.contains("allowLoadLocalInfile")) {
					properties_connectionStatsLogs += "&allowLoadLocalInfile=true";
				}

				String url_connectionStatsLogs = "jdbc:mysql://" + "127.0.0.1" + ":" + "3306" + "/" + "db_caba" + "?"
				...
				final String decryptedPassword_connectionStatsLogs = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"enc:routine.encryption.key.v1:HOVCYdR718VI2JpcCXkxVRNPM6Y4J/uNUGrsLgiUVdTDF4aGthXbMrEMHRM=");
	...
	public static class row_talendStats_STATSStruct
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA.length) {
					if (length < 1024
							&& commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA.length == 0) {
						commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA = new byte[1024];
					} else {
						commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA, 0, length);
				strReturn = new String(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Job_Recarga_Delitos_CABA, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void talendStats_STATSProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_talendStats_DB)) {// }
						if (GlobalResource.resourceMap.get(keyCheckTable_talendStats_DB) == null) {// }
							...
							try (java.sql.ResultSet rsTable_talendStats_DB = dbMetaData_talendStats_DB
									.getTables("db_caba", null, null, new String[] { "TABLE" })) {
				...
				String insert_talendStats_DB = "INSERT INTO `" + "talend_stats"
	...
	public void talendLogs_LOGSProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_talendLogs_DB = "INSERT INTO `" + "talend_log"
	...
	public void talendMeter_METTERProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						if (GlobalResource.resourceMap.get(keyCheckTable_talendMeter_DB) == null) {// }
							...
							if (!whetherExist_talendMeter_DB) {
								try (java.sql.Statement stmtCreate_talendMeter_DB = conn_talendMeter_DB
										.createStatement()) {
									stmtCreate_talendMeter_DB.execute("CREATE TABLE `" + tableName_talendMeter_DB
				...
				String insert_talendMeter_DB = "INSERT INTO `" + "talend_meter"
				...
				pstmt_talendMeter_DB = SharedDBPreparedStatement.getSharedPreparedStatement(conn_talendMeter_DB,
				...
				for (MetterCatcherUtils.MetterCatcherMessage mcm : talendMeter_METTER.getMessages()) {
					...
					if (row_talendMeter_METTER.moment != null) {
						...
						if (date_talendMeter_DB < year1_talendMeter_DB
							...
							pstmt_talendMeter_DB.setTimestamp(1, new java.sql.Timestamp(date_talendMeter_DB));
						}
					} else {
	...
	public static void main(String[] args) {
		final Job_Recarga_Delitos_CABA Job_Recarga_Delitos_CABAClass = new Job_Recarga_Delitos_CABA();

		int exitCode = Job_Recarga_Delitos_CABAClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_Recarga_Delitos_CABA.class.getClassLoader()
					.getResourceAsStream("workspace_talend_delitos_caba/job_recarga_delitos_caba_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_Recarga_Delitos_CABA.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Job_Recarga_Delitos_CABA");
		}
...
/************************************************************************************************
 * 132437 characters generated by Talend Open Studio for Data Integration on the
 * 26 de septiembre de 2021 1:00:50 ART
 ************************************************************************************************/