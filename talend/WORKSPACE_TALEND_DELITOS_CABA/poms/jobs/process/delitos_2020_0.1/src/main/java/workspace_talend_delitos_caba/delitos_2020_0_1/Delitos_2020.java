...
package workspace_talend_delitos_caba.delitos_2020_0_1;
...
/**
 * Job: Delitos_2020 Purpose: <br>
 * Description: Realiza la bajada del data set de delitos 2020 y los guarda en una base de datos MySQL <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Delitos_2020 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Delitos_2020";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_4g6XcB2hEeyohI-F3nx52Q", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_4g6XcB2hEeyohI-F3nx52Q", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Delitos_2020.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tFileFetch_1", System.currentTimeMillis());
				...
				talendStats_STATS.addMessage("begin","tFileFetch_1");
				talendStats_STATSProcess(globalMap);
...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	try {
			uriToFetch_tFileFetch_1 = new java.net.URI("https://cdn.buenosaires.gob.ar/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2020.csv");
	} 
	catch (Exception e) {
	...
	try { // B_01
			...
			System.err.println("There isContinue_tFileFetch_1 an exception on: " + "https://cdn.buenosaires.gob.ar/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2020.csv");
			e.printStackTrace();
			System.out.println("\r\n");
	...
	if (isContinue_tFileFetch_1) {    
			...
			String sDir_tFileFetch_1 = ("C:/temp").trim();
			String fileName_tFileFetch_1 = ("delitos_2020.csv").trim();    
			//open directory
			...
			iLastSlashIndex_tFileFetch_1 = sURIPath_tFileFetch_1.lastIndexOf("/");
				...
				sDir_tFileFetch_1 = sDir_tFileFetch_1.concat(iLastSlashIndex_tFileFetch_1 > 0 ? sURIPath_tFileFetch_1.substring(0, iLastSlashIndex_tFileFetch_1) : "");
...
talendStats_STATS.addMessage("end","tFileFetch_1", end_Hash.get("tFileFetch_1")-start_Hash.get("tFileFetch_1"));
talendStats_STATSProcess(globalMap);
...
public static class delitos_2020Struct implements routines.system.IPersistableRow<delitos_2020Struct> {
    final static byte[] commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020 = new byte[0];
    static byte[] commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020 = new byte[0];

	
			    public String id_mapa;
			    ...
			    public String uso_armas;

				public String getUso_armas () {
					return this.uso_armas;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020.length) {
				if(length < 1024 && commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020.length == 0) {
   					commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020 = new byte[1024];
				} else {
   					commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020, 0, length);
			strReturn = new String(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2020) {

        	try {

        		int length = 0;
		
					this.id_mapa = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.uso_armas,dos);
					...
					// Integer
						...
						writeInteger(this.victimas,dos);
    ...
    public String toString() {
		...
		sb.append(",victimas="+String.valueOf(victimas));
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(delitos_2020Struct other) {
...
delitos_2020Struct delitos_2020 = new delitos_2020Struct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"delitos_2020");
					}
...
String tableName_tDBOutput_1 = "delitos_2020";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:wjl2HeCQpDPJeLP8ib9ORXeRE8l7O2K82f4+MO2flQuQaBZhj0C1aInB9oE=");
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("db_caba", null, null, new String[]{"TABLE"})) {
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equalsIgnoreCase("delitos_2020")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id_mapa` VARCHAR(50)  ,`anio` INT(4)  ,`mes` VARCHAR(50)  ,`dia` VARCHAR(50)  ,`fecha` DATETIME ,`franja` VARCHAR(50)  ,`tipo` VARCHAR(50)  ,`subtipo` VARCHAR(50)  ,`uso_armas` VARCHAR(50)  ,`barrio` VARCHAR(50)  ,`comuna` INT(2)  ,`latitud` DOUBLE(20,9)  ,`longitud` DOUBLE(20,9)  ,`victimas` INT(1)  )");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "delitos_2020" + "` (`id_mapa`,`anio`,`mes`,`dia`,`fecha`,`franja`,`tipo`,`subtipo`,`uso_armas`,`barrio`,`comuna`,`latitud`,`longitud`,`victimas`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
delitos_2020Struct delitos_2020_tmp = new delitos_2020Struct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2020.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2020.csv", "UTF-8",",","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							row1.id_mapa = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.anio = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"anio", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.mes = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.dia = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
							...
							row1.franja = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row1.tipo = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							row1.subtipo = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 8;
					
							row1.uso_armas = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row1.barrio = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.comuna = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"comuna", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 11;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.latitud = ParserUtils.parseTo_Double(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"latitud", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 12;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.longitud = ParserUtils.parseTo_Double(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"longitud", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 13;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.victimas = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"victimas", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
// # Output table : 'delitos_2020'
delitos_2020_tmp.id_mapa = row1.id_mapa ;
delitos_2020_tmp.anio = row1.anio ;
delitos_2020_tmp.mes = row1.mes ;
delitos_2020_tmp.dia = row1.dia ;
delitos_2020_tmp.fecha = row1.fecha ;
delitos_2020_tmp.franja = row1.franja ;
delitos_2020_tmp.tipo = row1.tipo ;
delitos_2020_tmp.subtipo = row1.subtipo ;
delitos_2020_tmp.uso_armas = row1.uso_armas ;
delitos_2020_tmp.barrio = row1.barrio ;
delitos_2020_tmp.comuna = row1.comuna ;
delitos_2020_tmp.latitud = row1.latitud ;
delitos_2020_tmp.longitud = row1.longitud ;
delitos_2020_tmp.victimas = row1.victimas ;
delitos_2020 = delitos_2020_tmp;
// ###############################
 ...
 */
// Start of branch "delitos_2020"
if(delitos_2020 != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"delitos_2020");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                            if(delitos_2020.id_mapa == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, delitos_2020.id_mapa);
}

                            if(delitos_2020.anio == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, delitos_2020.anio);
}

                            if(delitos_2020.mes == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, delitos_2020.mes);
}

                            if(delitos_2020.dia == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, delitos_2020.dia);
}

                            if(delitos_2020.fecha != null) {
date_tDBOutput_1 = delitos_2020.fecha.getTime();
...
pstmt_tDBOutput_1.setNull(5, java.sql.Types.DATE);
                            ...
                            if(delitos_2020.franja == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, delitos_2020.franja);
}

                            if(delitos_2020.tipo == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, delitos_2020.tipo);
}

                            if(delitos_2020.subtipo == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, delitos_2020.subtipo);
}

                            if(delitos_2020.uso_armas == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, delitos_2020.uso_armas);
}

                            if(delitos_2020.barrio == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, delitos_2020.barrio);
}

                            if(delitos_2020.comuna == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(11, delitos_2020.comuna);
}

                            if(delitos_2020.latitud == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(12, delitos_2020.latitud);
}

                            if(delitos_2020.longitud == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(13, delitos_2020.longitud);
}

                            if(delitos_2020.victimas == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(14, delitos_2020.victimas);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2020.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"delitos_2020");
			  	}
...
public void connectionStatsLogsProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_connectionStatsLogs = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:1uZKJZxfZgm/5MsbhuZVLNxhHjWn/Il/QMqtDTKOleybY8JKebtGwyMa40s=");
 ...
 */
    ...
    public static void main(String[] args){
        final Delitos_2020 Delitos_2020Class = new Delitos_2020();

        int exitCode = Delitos_2020Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Delitos_2020.class.getClassLoader().getResourceAsStream("workspace_talend_delitos_caba/delitos_2020_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Delitos_2020.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Delitos_2020");
        }
...
/************************************************************************************************
 *     166324 characters generated by Talend Open Studio for Data Integration 
