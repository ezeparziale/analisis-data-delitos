...
package workspace_talend_delitos_caba.delitos_2019_0_1;
...
/**
 * Job: Delitos_2019 Purpose: <br>
 * Description: Realiza la bajada del data set de delitos 2019 y los guarda en una base de datos MySQL <br>
 * @author 
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Delitos_2019 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Delitos_2019";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils talendStats_STATS = new StatCatcherUtils("_Fr978B2AEeyohI-F3nx52Q", "0.1");
	MetterCatcherUtils talendMeter_METTER = new MetterCatcherUtils("_Fr978B2AEeyohI-F3nx52Q", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Delitos_2019.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.InputStream retIS_tFileFetch_1 = null;
	...
	try {
			uriToFetch_tFileFetch_1 = new java.net.URI("https://cdn.buenosaires.gob.ar/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2019.csv");
	} 
	catch (Exception e) {
	...
	try { // B_01
			...
			System.err.println("There isContinue_tFileFetch_1 an exception on: " + "https://cdn.buenosaires.gob.ar/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2019.csv");
			e.printStackTrace();
			System.out.println("\r\n");
	...
	if (isContinue_tFileFetch_1) {    
			...
			String fileName_tFileFetch_1 = ("delitos_2019.csv").trim();    
			//open directory
...
public static class delitos_2019Struct implements routines.system.IPersistableRow<delitos_2019Struct> {
    final static byte[] commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019 = new byte[0];
    static byte[] commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019 = new byte[0];
			    ...
			    public String cantidad_registrada;

				public String getCantidad_registrada () {
					return this.cantidad_registrada;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019.length) {
				if(length < 1024 && commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019.length == 0) {
   					commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019 = new byte[1024];
				} else {
   					commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019, 0, length);
			strReturn = new String(commonByteArray_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WORKSPACE_TALEND_DELITOS_CABA_Delitos_2019) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.cantidad_registrada = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.cantidad_registrada,dos);
    ...
    public String toString() {
		...
		sb.append(",cantidad_registrada="+cantidad_registrada);
     ...
     * Compare keys
     */
    public int compareTo(delitos_2019Struct other) {
...
delitos_2019Struct delitos_2019 = new delitos_2019Struct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"delitos_2019");
					}
...
String tableName_tDBOutput_1 = "delitos_2019";
...
java.sql.Connection conn_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:uJ9rff6R0dF8aB4PiE6X4tu0xsheVz2PGS+XeRkxlBth6jqK3Ju3svfEsdI=");
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("db_caba", null, null, new String[]{"TABLE"})) {
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equalsIgnoreCase("delitos_2019")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`id` VARCHAR(50)  ,`fecha` DATETIME ,`franja_horaria` VARCHAR(50)  ,`tipo_delito` VARCHAR(50)  ,`subtipo_delito` VARCHAR(50)  ,`cantidad_registrada` VARCHAR(50)  ,`comuna` INT(2)  ,`barrio` VARCHAR(50)  ,`latitud` DOUBLE(20,9)  ,`longitud` DOUBLE(20,9)  )");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "delitos_2019" + "` (`id`,`fecha`,`franja_horaria`,`tipo_delito`,`subtipo_delito`,`cantidad_registrada`,`comuna`,`barrio`,`latitud`,`longitud`) VALUES (?,?,?,?,?,?,?,?,?,?)";
...
delitos_2019Struct delitos_2019_tmp = new delitos_2019Struct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2019.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2019.csv", "UTF-8",",","\n",false,1,0,
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.franja_horaria = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.tipo_delito = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row1.subtipo_delito = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row1.cantidad_registrada = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'delitos_2019'
delitos_2019_tmp.id = row1.id ;
delitos_2019_tmp.fecha = row1.fecha ;
delitos_2019_tmp.franja_horaria = row1.franja_horaria ;
delitos_2019_tmp.tipo_delito = row1.tipo_delito ;
delitos_2019_tmp.subtipo_delito = row1.subtipo_delito ;
delitos_2019_tmp.cantidad_registrada = row1.cantidad_registrada ;
delitos_2019_tmp.comuna = row1.comuna ;
delitos_2019_tmp.barrio = row1.barrio ;
delitos_2019_tmp.latitud = row1.latitud ;
delitos_2019_tmp.longitud = row1.longitud ;
delitos_2019 = delitos_2019_tmp;
// ###############################
 ...
 */
// Start of branch "delitos_2019"
if(delitos_2019 != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"delitos_2019");
					}
        ...
        whetherReject_tDBOutput_1 = false;
                            if(delitos_2019.id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, delitos_2019.id);
}

                            if(delitos_2019.fecha != null) {
date_tDBOutput_1 = delitos_2019.fecha.getTime();
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.DATE);
                            ...
                            if(delitos_2019.franja_horaria == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, delitos_2019.franja_horaria);
}

                            if(delitos_2019.tipo_delito == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, delitos_2019.tipo_delito);
}

                            if(delitos_2019.subtipo_delito == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, delitos_2019.subtipo_delito);
}

                            if(delitos_2019.cantidad_registrada == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, delitos_2019.cantidad_registrada);
}

                            if(delitos_2019.comuna == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(7, delitos_2019.comuna);
}

                            if(delitos_2019.barrio == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, delitos_2019.barrio);
}

                            if(delitos_2019.latitud == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(9, delitos_2019.latitud);
}

                            if(delitos_2019.longitud == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_1.setDouble(10, delitos_2019.longitud);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("C:/temp/datosabiertos/datasets/ministerio-de-justicia-y-seguridad/delitos/delitos_2019.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"delitos_2019");
			  	}
...
public void connectionStatsLogsProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_connectionStatsLogs = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6XkLDJFL5sSnFvBdfP4cvdckFHyOb40nKD2IWRHPz9VUeERMKQI5071JMSQ=");
 ...
 */
    ...
    public static void main(String[] args){
        final Delitos_2019 Delitos_2019Class = new Delitos_2019();

        int exitCode = Delitos_2019Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Delitos_2019.class.getClassLoader().getResourceAsStream("workspace_talend_delitos_caba/delitos_2019_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Delitos_2019.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Delitos_2019");
        }
...
/************************************************************************************************
 *     162103 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 de septiembre de 2021 1:00:49 ART
 ************************************************************************************************/